...
export default function Navbar() {
  ...
  return (
    <nav
      className="relative z-50 bg-gradient-to-r from-[#0E4BA9] via-[#007BCE] to-[#00A6FB] text-white shadow-lg"
      style={{
        boxShadow:
    ...
    >
      <div className="flex items-center justify-between px-5 md:px-10 py-3">
        ...
        >
          ...
          ></div>
          <div
            className={`w-6 h-[2px] bg-white my-[5px] transition-all ${
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            className="md:hidden bg-gradient-to-b from-[#0E4BA9] to-[#007BCE] text-white shadow-2xl px-6 py-7 space-y-6 text-center rounded-b-3xl border-t border-white/20"
          >
            {/* 🧭 Title */}
            ...
            <div className="bg-white/10 rounded-2xl py-4 space-y-3 border border-white/20 shadow-inner">
              ...
              >
                🏠 WeWIN <span className="text-[#FFE08A]">HTO</span>
              </Link>
